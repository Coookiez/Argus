	...
	: Layer("ExampleLayer"), m_CameraController(1280.0f / 720.0f)
{
	...
	m_ChernoLogoTexture = Argus::Texture2D::Create("assets/textures/ChernoLogo.png");
...
void ExampleLayer::OnUpdate(Argus::Timestep ts)
{
	// Update
...
void ExampleLayer::OnEvent(Argus::Event& e)
{
