...
namespace Argus
{
	static b2BodyType ArgusRigidbody2DTypeToBox2D(Rigidbody2DComponent::BodyType bodyType)
	{
		switch (bodyType)
		{
	...
	static void CopyComponent(entt::registry& dst, entt::registry& src, const std::unordered_map<UUID, entt::entity>& enttMap)
	{
		...
		for (auto e : view)
		{
			...
			AS_CORE_ASSERT(enttMap.find(uuid) != enttMap.end());
	...
	void Scene::OnRuntimeStart()
	{
		...
		for (auto e : view)
		{
			...
			b2BodyDef bodyDef;
			bodyDef.type = ArgusRigidbody2DTypeToBox2D(rb2d.Type);
