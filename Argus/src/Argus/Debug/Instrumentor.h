...
#define AS_PROFILE_BEGIN_SESSION(name, filepath) ::Argus::Instrumentor::Get().BeginSession(name, filepath)
#define AS_PROFILE_END_SESSION() ::Argus::Instrumentor::Get().EndSession()
#define AS_PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::Argus::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
											   ::Argus::InstrumentationTimer timer##line(fixedName##line.Data)
